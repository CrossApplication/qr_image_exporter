...
Import both the core `qr` package and the `qr_image_exporter` extension.
...
void main() {
  ...
  final qrCode = QrCode.fromData(
    data: '[https://pub.dev/packages/qr_image_exporter](https://pub.dev/packages/qr_image_exporter)',
